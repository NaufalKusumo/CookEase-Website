...
<body class="bg-gray-50">
    ...
    <header class="bg-white shadow-sm">
        <nav class="container mx-auto p-4 flex justify-between items-center">
            ...
            <div>@auth <button id="open-modal-btn" class="px-6 py-2 bg-yellow-500 text-white font-semibold rounded-full hover:bg-yellow-600">Buat!</button> @endauth</div>
        </nav>
    </header>
    ...
    <main class="container mx-auto p-8">
        ...
        @if (!$recipes->isEmpty())
            <section class="mb-12">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Resep Ditemukan</h2>
        ...
        @if (!$tips->isEmpty())
            <section class="mb-12">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Tips Dapur Ditemukan</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                     @foreach ($tips as $tip)
